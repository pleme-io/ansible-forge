    ...
    crates = {
      ...
      "iac-forge" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "4d7746648c42de8fd9d039adc04c570e395cefaf";
      ...
      "openapi-forge" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "ce6507e6175af7aa421b8552d04685aa43b5d5fa";
      ...
      "takumi" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "cf8a93b06d9407bd23f26afa76fc04b37fa1bf4b";
          sha256 = "1jhp96bwg1ljrv2mcipgy058i5djs2ydc2vlsalmxbdq2ba4slq5";
        };
        dependencies = [
          {
            name = "indexmap";
